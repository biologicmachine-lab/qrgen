...
<head>
  ...
  <title>QR Generator Pro — Offline Single File</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/Z1srPv7lOy9C27hHQ+Xp8a4MxAQ5a+W5U8lXKfekQm0Zvs+nLTIsGPKoeG1cV8qW6g==" crossorigin="anonymous" referrerpolicy="no-<script src="https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js"></script>
  <style>
...
<div class="wrap">
  ...
  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center">
      <div>
        <h2 style="margin:0">QR Generator Pro — Offline</h2>
...
<body>
  <div style="text-align:center;margin-top:16px" class="small">&copy; 2024 QR Generator Pro — Online Single File</div>
